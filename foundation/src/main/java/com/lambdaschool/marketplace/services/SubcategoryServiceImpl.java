...
public class SubcategoryServiceImpl implements SubcategoryService {
    ...
    public List<Subcategory> findAllSubcategories() {
        ...
        subcategoryRepository.findAll().iterator().forEachRemaining(subcategoryList::add);
    ...
    public Subcategory findBySubcategoryId(long subcategoryId) {
        return subcategoryRepository.findById(subcategoryId)
                .orElseThrow(
                        () -> new ResourceNotFoundException("Subcategory ID " + subcategoryId + " not found!")
                );
    }
    ...
    public void delete(long subcategoryId) {
        subcategoryRepository.findById(subcategoryId)
                .orElseThrow(
                        () -> new RuntimeException("Subcategory ID " + subcategoryId + " not found!")
                );
